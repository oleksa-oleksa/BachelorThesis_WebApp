...
\end{lstlisting}
Als letztes für die Implementierung des Register-Clients ist wichtig, die kurze Beschreibung der entwickelte von Autorin JSON-Datei zu geben. Definieren der Struktur, des Inhalts und der Semantik von JSON-Objekten geschieht mithilfe von der Grammatiksprache namens JSON-Schema. Hier kann Metadaten (Daten zu Daten) angegeben werden, die die Eigenschaften eines Objekts bedeuten und beschreiben, welche Werte für diese Eigenschaften gültig sind. 
