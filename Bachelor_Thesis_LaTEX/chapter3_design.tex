...
Betriebsansicht - das System aus Sicht des Benutzers oder "Bedieners". Dies umfasst Artefakte in Bezug auf praktische Anwendungsphasen, Szenarien und Workflows.


Die Architektur sollte klar zeigen: wie alle drei Arten von Beschreibungen der miteinander verbundenen „transparenten Box“ die Hauptfunktionen des Systems ergeben. Architektur ist also untrennbar mit Anforderungen verbunden. Die Anforderungen, die die Architektur am meisten beeinflussen, werden als architektonische Anforderungen bezeichnet.
