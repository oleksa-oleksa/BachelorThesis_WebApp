...
% **************************************************
\newcommand{\thesisTitle}{\Huge Bachelorarbeit}
\newcommand{\thesisTitleEng}{\Large Entwicklung einer Datenbank-Applikation für das "acaLoan-Raspi"-Projekt des PSE-Labors}
\newcommand{\thesisTitleDe}{\large Development of a database application for the "acaLoan-Raspi" project of the PSE laboratory}
\newcommand{\thesisName}{Oleksandra Baga}
\newcommand{\thesisDate}{31.10.2020}
