...
Real Application (Server + Display) is presented on tablet and gets interactively requests from RFID reader connected to MacBook. Tha page shows the successful operation.
